...
class BrowserManager:
    ...
    # AUDIT-012: Track active contexts to prevent cleanup race
    ...
    async def launch(
        ...
        # AUDIT-012: Increment active context counter
        ...
        if email:
            # AUDIT-018: Use json.dumps to prevent XSS in email injection
