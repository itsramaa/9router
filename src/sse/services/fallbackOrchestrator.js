...
export async function runWithFallback({
  ...
  while (true) {
    ...
    // 400 (bad request), 401/403 (auth — already retried with refresh above), 404 (not found)

    // are client-side issues; only 429/402 (quota/rate limit) should trigger fallback
