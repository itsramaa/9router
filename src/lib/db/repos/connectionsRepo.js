...
/**
 * Atomic read-compute-write for backoffLevel (and optional extra fields).
 * @param {string} id
 * @param {(currentBackoffLevel: number) => { newBackoffLevel: number, extraFields?: object }} computeFn
 */
