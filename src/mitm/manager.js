...
const { addDNSEntry, removeDNSEntry, removeAllDNSEntries, removeAllDNSEntriesSync, checkAllDNSStatus, TOOL_HOSTS, isSudoAvailable, isSudoPasswordRequired, isManualDnsMode } = require("./dns/dnsConfig");
...
async function getMitmStatus() {
  ...
  return { running, pid, certExists, certTrusted, dnsStatus, manualDnsMode: isManualDnsMode() };
