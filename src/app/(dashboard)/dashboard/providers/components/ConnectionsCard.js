...
function CooldownTimer({ until }) {
  ...
  return (
    <span className="text-xs text-orange-500 font-mono">â± {remaining}</span>
  );
}
CooldownTimer.propTypes = { until: PropTypes.string.isRequired };
const BAN_KEYWORDS_CARD = [
  'banned',
  'suspended',
  'terminated',
  'blocked',
...
function ConnectionRow({
  ...
  const isBanned =
    ...
    BAN_KEYWORDS_CARD.some((k) =>
      connection.lastError.toLowerCase().includes(k)
    );
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex flex-wrap items-center gap-2 mt-1">
            ...
            {isPaused && connection.lastError && (
              <span
                className="text-xs text-orange-500 truncate max-w-[300px]"
                title={connection.lastError}
              >
                {connection.lastError}
              </span>
...
// â”€â”€ AddApiKeyModal â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ ConnectionsCard â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
