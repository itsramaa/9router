...
export default function MitmPageClient() {
  ...
  const [mitmStatus, setMitmStatus] = useState({ running: false, certExists: false, dnsStatus: {}, hasCachedPassword: false, manualDnsMode: false });
      ...
      <div className="grid gap-3 sm:gap-4">
        {mitmTools.map(([toolId, tool]) => (
          <MitmToolCard
            ...
            manualDnsMode={mitmStatus.manualDnsMode || false}
