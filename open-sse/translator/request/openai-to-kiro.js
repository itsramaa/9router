...
export function openaiToKiroRequest(model, body, stream, credentials) {
  ...
  // REMOVED: Kiro direct API calls reject top-level systemPrompt with REQUEST_BODY_INVALID.
  // System prompt injection happens via contentPrefix → message content instead.
  // if (systemPrompt) payload.systemPrompt = systemPrompt;
  const additionalModelRequestFields =
    buildKiroAdditionalModelRequestFieldsForModel(body, upstreamModel);
