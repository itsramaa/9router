  ...
  try {
    ...
    const quotas = {
      user: {
        ...
        // BUG-015/016 fix: expiresAt is account subscription expiry, NOT quota reset date

        // Setting it as resetAt would display "resets in 2912271d" in UI
    ...
    return {
      ...
      // expiresAt intentionally NOT surfaced as resetAt — it's account expiry, not quota reset
    };
  } catch (error) {
    return {
